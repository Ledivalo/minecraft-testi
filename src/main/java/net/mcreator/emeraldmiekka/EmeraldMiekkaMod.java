package net.mcreator.emeraldmiekka;
...
@Mod("emerald_miekka")
public class EmeraldMiekkaMod {
	public static final Logger LOGGER = LogManager.getLogger(EmeraldMiekkaMod.class);
	public static final String MODID = "emerald_miekka";

	public EmeraldMiekkaMod(IEventBus modEventBus) {
